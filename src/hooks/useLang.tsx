...
const t: Translations = {
  ...
  "Tiap Bulan": { id: "Tiap Bulan", en: "Monthly" },
  "Tiap Tahun": { id: "Tiap Tahun", en: "Yearly" },

  // --- Keuangan extended ---
  "Semua Tipe": { id: "Semua Tipe", en: "All Types" },
  "Hapus": { id: "Hapus", en: "Delete" },
  "(kamu)": { id: "(kamu)", en: "(you)" },
  "Terakhir online:": { id: "Terakhir online:", en: "Last online:" },
  "Hapus kontak ini?": { id: "Hapus kontak ini?", en: "Delete this contact?" },
  "Hapus dokumen ini?": { id: "Hapus dokumen ini?", en: "Delete this document?" },
  "Link Google Drive": { id: "Link Google Drive", en: "Google Drive link" },
  "Tagihan terdekat": { id: "Tagihan terdekat", en: "Upcoming bill" },
  "berulang": { id: "berulang", en: "recurring" },
  "hari telat": { id: "hari telat", en: "days overdue" },
  "Jatuh tempo hari ini — jangan lupa dibayar!": { id: "Jatuh tempo hari ini — jangan lupa dibayar!", en: "Due today — don't forget to pay!" },
  "SUDAH TERLAMBAT": { id: "SUDAH TERLAMBAT", en: "OVERDUE" },
  "hari — segera lunasi!": { id: "hari — segera lunasi!", en: "days — pay immediately!" },
  "Lunasi": { id: "Lunasi", en: "Pay off" },
  "Detail": { id: "Detail", en: "Details" },
  "Hapus catatan ini?": { id: "Hapus catatan ini?", en: "Delete this note?" },
  "Hapus tugas ini?": { id: "Hapus tugas ini?", en: "Delete this task?" },
  "Tanpa Gambar": { id: "Tanpa Gambar", en: "No Image" },
  "Upload gambar": { id: "Upload gambar", en: "Upload image" },
  "Gagal menambah tugas": { id: "Gagal menambah tugas", en: "Failed to add task" },
  "Tugas ditambahkan": { id: "Tugas ditambahkan", en: "Task added" },
  "Tugas dihapus": { id: "Tugas dihapus", en: "Task deleted" },
  "Tambah Tugas": { id: "Tambah Tugas", en: "Add Task" },
  "Masukkan nama tugas...": { id: "Masukkan nama tugas...", en: "Enter task name..." },
  "Tugas Berulang": { id: "Tugas Berulang", en: "Recurring Task" },
  "Muncul setiap hari": { id: "Muncul setiap hari", en: "Appears every day" },
  "Batas 5 tugas/hari tercapai": { id: "Batas 5 tugas/hari tercapai", en: "Daily task limit reached (5)" },
  "Upgrade ke Family untuk tugas tak terbatas": { id: "Upgrade ke Family untuk tugas tak terbatas", en: "Upgrade to Family for unlimited tasks" },
  "Upgrade": { id: "Upgrade", en: "Upgrade" },
  "SUDAH TERLAMBAT {n} hari — segera lunasi!": { id: "SUDAH TERLAMBAT {n} hari — segera lunasi!", en: "OVERDUE {n} days — settle immediately!" },
  "Resep": { id: "Resep", en: "Recipes" },
  "Belum ada resep": { id: "Belum ada resep", en: "No recipes yet" },
  "Edit Resep": { id: "Edit Resep", en: "Edit Recipe" },
  "Deskripsi": { id: "Deskripsi", en: "Description" },
  "Bahan, langkah, dsb...": { id: "Bahan, langkah, dsb...", en: "Ingredients, steps, etc..." },
  "Menyimpan...": { id: "Menyimpan...", en: "Saving..." },
  "Muat Lebih": { id: "Muat Lebih", en: "Load More" },
  "Cari resep...": { id: "Cari resep...", en: "Search recipes..." },
  "Nama resep...": { id: "Nama resep...", en: "Recipe name..." },
  "Gambar": { id: "Gambar", en: "Image" },
  "Lihat Semua Resep": { id: "Lihat Semua Resep", en: "View All Recipes" },
  ...
  "Gagal memuat resep": { id: "Gagal memuat resep", en: "Failed to load recipes" },
  "Tidak ada resep": { id: "Tidak ada resep", en: "No recipes" },
  "Tambah Resep": { id: "Tambah Resep", en: "Add Recipe" },
