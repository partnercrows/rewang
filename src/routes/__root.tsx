...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rumahku — Kolaborasi Rumah Tangga" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Rumahku — Kolaborasi Rumah Tangga" },
      { property: "og:description", content: "Atur rumah tangga bersama keluarga dalam satu aplikasi." },
